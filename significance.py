...
bkg_e = []
lista = []
x_e=["0-100", "100-200", "200-300", "300-400", "400-500", "500-600", "600-700", "700-800", "800-900", "900-1000", "1000-1100", "1100-2500"]
x_mu=["0-100", "100-200", "200-300", "300-400", "400-500", "500-600", "600-700", "700-800", "800-900","900-1000", "1000-1100","1100-1200", "1200-2500"]
i=1
#suma bkgs 
while i < len(data[0]):
...
l_350_mu = (lista[0][3] + lista[0][4] + lista[0][5])/(np.sqrt(3))
...
l_350_ct = (lista[0][3] + lista[0][4] + lista[0][5] + lista[4][3] + lista[4][4] + lista[4][5] + (1.619344776881605*np.sqrt(4)))/(np.sqrt(10))
l_1000_ct = (lista[1][8] + lista[1][9] + lista[1][10] + lista[1][11] + lista[1][12] + lista[5][8] + lista[5][9] + lista[5][10] + lista[5][11] + (2.68283799787817*np.sqrt(8)))/(np.sqrt(17))
l_1500_ct = (lista[2][11] + lista[2][12] + lista[6][11] + (2.413484852495129*np.sqrt(7)))/(np.sqrt(10))
l_2000_ct = 0


x_s=[150,200,250,300]
xx= [350,1000,1500,2000]
xx2= [350,1000,1500]
y1= [1.177264775463348, 1.8824382638619135, 1.9759446841110868 , 2.3122443788948916]
y11=[l_350_c, l_1000_c, l_1500_c, l_2000_c]
y44=[l_350_ct, l_1000_ct, l_1500_ct]
y2= [0.9525492081463478, 1.2776149682301627, 1.4096202452739266, 1.6304886423876415]
y22=[l_350_mu, l_1000_mu, l_1500_mu, l_2000_mu]
y3= [0.691974396075, 1.3837847335628353, 1.3847875254949928, 1.6395187177664683]
y33= [l_350_e, l_1000_e, l_1500_e, l_2000_e]

plt.subplot(1,2,1)
plt.plot(x_s, y1, label= r'$e_{\tau}$ + $\mu_{\tau}$', marker = '.', markersize = 10, linewidth = 2)
plt.plot(x_s, y2, label= r'$\mu_{\tau}$', marker = '.', markersize = 10, linewidth = 2)
plt.plot(x_s, y3, label= r'$e_{\tau}$ ', marker = '.', markersize = 10, linewidth = 2)
plt.legend(loc='best')
plt.grid()
plt.xlabel(r'$m_{Z^{\prime}}$ GeV')
plt.ylabel(r'$\sigma_{tot}$')
plt.subplot(1,2,2)
plt.plot(xx, y11, label= r'$e_{\tau}$ + $\mu_{\tau}$', marker = '.', markersize = 10, linewidth = 2)
plt.plot(xx, y22, label= r'$\mu_{\tau}$', marker = '.', markersize = 10, linewidth = 2)
plt.plot(xx, y33, label= r'$e_{\tau}$', marker = '.', markersize = 10, linewidth = 2)
plt.plot(xx2, y44, label= r' $e_{\tau} \  + \ \mu_{\tau} + \ e_{\mu} \  + \ \mu_{\mu}$ ', marker = '.', markersize = 10, linewidth = 2)
plt.legend(loc='best')
plt.grid()
plt.xlabel(r'$m_{Z^{\prime}}$ GeV')
plt.ylabel(r'$\sigma_{tot}$')
